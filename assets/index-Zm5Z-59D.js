var P=Object.defineProperty;var R=(s,t,e)=>t in s?P(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var _=(s,t,e)=>R(s,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function e(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=e(n);fetch(n.href,a)}})();const x="gym_twa_data",S="https://functions.yandexcloud.net/d4ehnqvq3a8fo55t7tj4";var C;const b=(C=window.Telegram)==null?void 0:C.WebApp,D={workoutTypes:[{id:"1",name:"Жим лежа"},{id:"2",name:"Приседания"},{id:"3",name:"Становая тяга"}],logs:[]};class q{constructor(){_(this,"data");_(this,"onUpdateCallback");_(this,"onSyncStatusChangeCallback");_(this,"status","idle");this.data=this.loadLocal()}getHeaders(){const t={"Content-Type":"application/json"};return b!=null&&b.initData&&(t["X-Telegram-Init-Data"]=b.initData),t}async init(){await this.syncFromServer()}onUpdate(t){this.onUpdateCallback=t}onSyncStatusChange(t){this.onSyncStatusChangeCallback=t}setStatus(t){var e;this.status=t,(e=this.onSyncStatusChangeCallback)==null||e.call(this,t),t==="success"&&setTimeout(()=>{this.status==="success"&&this.setStatus("idle")},2e3)}loadLocal(){const t=localStorage.getItem(x);if(!t)return D;try{return JSON.parse(t)}catch(e){return console.error("Failed to parse storage data",e),D}}saveLocal(){localStorage.setItem(x,JSON.stringify(this.data))}async syncFromServer(){var t;this.setStatus("saving");try{const e=await fetch(S,{headers:this.getHeaders()});if(e.ok){const i=await e.json();i&&(i.workoutTypes||i.logs)&&(this.data=i,this.saveLocal(),(t=this.onUpdateCallback)==null||t.call(this)),this.setStatus("success")}else this.setStatus("error")}catch(e){console.error("Failed to sync from server",e),this.setStatus("error")}}async saveToServer(){this.setStatus("saving");try{await fetch(S,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(this.data)}),this.setStatus("success")}catch(t){console.error("Failed to save to server",t),this.setStatus("error")}}async persist(){this.saveLocal(),await this.saveToServer()}getWorkoutTypes(){return this.data.workoutTypes}async addWorkoutType(t){const e={id:Date.now().toString(),name:t};return this.data.workoutTypes.push(e),await this.persist(),e}async deleteWorkoutType(t){this.data.workoutTypes=this.data.workoutTypes.filter(e=>e.id!==t),await this.persist()}getLogs(){return this.data.logs}async addLog(t){const e={...t,id:Date.now().toString(),date:new Date().toISOString()};return this.data.logs.push(e),await this.persist(),e}async deleteLog(t){this.data.logs=this.data.logs.filter(e=>e.id!==t),await this.persist()}async updateLog(t){const e=this.data.logs.findIndex(i=>i.id===t.id);e!==-1&&(this.data.logs[e]=t,await this.persist())}getProfile(){return this.data.profile}getProfileIdentifier(){var i,n;const t=this.data.profile;if(t!=null&&t.telegramUsername)return t.telegramUsername;if(t!=null&&t.telegramUserId)return`id_${t.telegramUserId}`;const e=(n=(i=b==null?void 0:b.initDataUnsafe)==null?void 0:i.user)==null?void 0:n.id;return e?`id_${e}`:""}async updateProfileSettings(t){var l,o;const e=(l=b==null?void 0:b.initDataUnsafe)==null?void 0:l.user,i=e==null?void 0:e.id,n=e==null?void 0:e.username,a=e==null?void 0:e.photo_url;this.data.profile?a&&(this.data.profile.photoUrl=a):this.data.profile={isPublic:!1,showFullHistory:!1,telegramUserId:i||0,telegramUsername:n,photoUrl:a,createdAt:new Date().toISOString()},this.data.profile={...this.data.profile,...t},await this.persist(),(o=this.onUpdateCallback)==null||o.call(this)}async getPublicProfile(t){try{const e=await fetch(`${S}?profile=${encodeURIComponent(t)}`);return e.ok?await e.json():null}catch(e){return console.error("Failed to fetch public profile",e),null}}}const r=new q;var j;const v=(j=window.Telegram)==null?void 0:j.WebApp;v&&(v.ready(),v.expand());let y="main",k="all",g=null,N=null,L=null,I=!1;function F(s){y=s,u()}let T=null;function E(s){let t=document.querySelector(".toast");t||(t=document.createElement("div"),t.className="toast",document.body.appendChild(t)),t.textContent=s,t.classList.add("visible"),T&&clearTimeout(T),T=setTimeout(()=>{t==null||t.classList.remove("visible")},2e3)}function u(){const s=document.getElementById("app");s&&(s.innerHTML=`
  ...
  `,s.querySelectorAll(".navigation__item").forEach(t=>{t.addEventListener("click",()=>{const e=t.getAttribute("data-page");F(e)})}),Q())}function H(){switch(y){case"main":return A();case"stats":return J();case"settings":return V();case"profile-settings":return z();case"public-profile":return G();default:return""}}let w=0,U="";function O(s){const t=new Date;t.setHours(0,0,0,0);const e=new Date(t);e.setDate(t.getDate()-s*7),e.setHours(23,59,59,999);const i=new Date(e);return i.setDate(e.getDate()-6),i.setHours(0,0,0,0),{start:i,end:e,label:`${i.toLocaleDateString("ru-RU",{day:"numeric",month:"short"})} - ${e.toLocaleDateString("ru-RU",{day:"numeric",month:"short"})}`}}function A(){var l;const s=r.getWorkoutTypes(),t=r.getLogs(),e=t[t.length-1],i=e==null?void 0:e.workoutTypeId,n=g?t.find(o=>o.id===g):null,{label:a}=O(w);return`
  ...
  `}function z(){var d,p;const s=r.getProfile(),t=(s==null?void 0:s.isPublic)??!1,e=(s==null?void 0:s.displayName)||((p=(d=v==null?void 0:v.initDataUnsafe)==null?void 0:d.user)==null?void 0:p.first_name)||"",i=r.getProfileIdentifier(),n=i?`https://t.me/gymgym21bot/app?startapp=profile_${i}`:"",a=r.getLogs(),l=a.reduce((c,f)=>c+f.weight*f.reps,0),o=new Set(a.map(c=>c.date.split("T")[0])).size;return`
  ...
  `}function K(s){if(s.length<2)return'<p class="hint" style="text-align: center">Мало данных для графика</p>';const e=[...s].sort((c,f)=>new Date(c.date).getTime()-new Date(f.date).getTime()).map(c=>c.weight),i=Math.min(...e),n=Math.max(...e),a=n-i||1,l=400,o=150,d=20,p=e.map((c,f)=>{const h=d+f/(e.length-1)*(l-2*d),m=o-d-(c-i)/a*(o-2*d);return`${h},${m}`}).join(" ");return`
  ...
  `}function X(s){const t=r.getLogs(),e=r.getWorkoutTypes(),i=t.filter(p=>p.date.startsWith(s));if(i.length===0)return"";const a=new Date(i[0].date).toLocaleDateString("ru-RU",{day:"numeric",month:"long"}),l=new Map;i.forEach(p=>{l.has(p.workoutTypeId)||l.set(p.workoutTypeId,[]),l.get(p.workoutTypeId).push(p)});let o=`🏋️ Тренировка ${a}

`;l.forEach((p,c)=>{const f=e.find(h=>h.id===c);o+=`${(f==null?void 0:f.name)||"Упражнение"}:
`,p.forEach(h=>{o+=`  ${h.weight} кг × ${h.reps}
`}),o+=`
`});const d=i.reduce((p,c)=>p+c.weight*c.reps,0);return o+=`💪 Общий объём: ${Math.round(d)} кг`,o}function Y(s){const t=X(s);if(t)if(v!=null&&v.openTelegramLink){const e=`https://t.me/share/url?url=${encodeURIComponent("https://t.me/gymgym21bot")}&text=${encodeURIComponent(t)}`;v.openTelegramLink(e)}else navigator.clipboard.writeText(t).then(()=>{alert("Текст скопирован в буфер обмена")})}function Q(){if(y==="main"){const s=document.getElementById("log-form");s==null||s.addEventListener("submit",async l=>{l.preventDefault();const o=new FormData(s),d={workoutTypeId:o.get("typeId"),weight:parseFloat(o.get("weight")),reps:parseInt(o.get("reps"),10)};if(g){const c=r.getLogs().find(f=>f.id===g);c&&(await r.updateLog({...c,...d}),g=null)}else await r.addLog(d);u()});const t=document.getElementById("duplicate-last-btn");t==null||t.addEventListener("click",async()=>{const l=r.getLogs(),o=l[l.length-1];o&&(await r.addLog({workoutTypeId:o.workoutTypeId,weight:o.weight,reps:o.reps}),u())});const e=document.getElementById("cancel-edit-btn");e==null||e.addEventListener("click",()=>{g=null,u()}),document.querySelectorAll(".log-set__delete").forEach(l=>{l.addEventListener("click",async()=>{const o=l.getAttribute("data-id");o&&(g===o&&(g=null),await r.deleteLog(o),u())})}),document.querySelectorAll(".log-set__edit").forEach(l=>{l.addEventListener("click",()=>{g=l.getAttribute("data-id"),u(),window.scrollTo({top:0,behavior:"smooth"})})}),document.querySelectorAll(".share-btn").forEach(l=>{l.addEventListener("click",()=>{const o=l.getAttribute("data-date");o&&Y(o)})});const i=document.getElementById("prev-week-btn");i==null||i.addEventListener("click",()=>{w++,u()});const n=document.getElementById("next-week-btn");n==null||n.addEventListener("click",()=>{w>0&&(w--,u())});const a=document.getElementById("calendar-input");a==null||a.addEventListener("change",()=>{if(a.value===U||!a.value)return;U=a.value;const l=new Date(a.value),o=new Date;o.setHours(0,0,0,0);const d=o.getTime()-l.getTime(),p=Math.floor(d/(1e3*60*60*24));w=Math.max(0,Math.floor(p/7)),u()})}if(y==="settings"){const s=document.getElementById("add-type-form");s==null||s.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("new-type-name");e.value&&(await r.addWorkoutType(e.value),u())}),document.querySelectorAll(".type-item__delete").forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");e&&confirm("Удалить этот тип тренировки?")&&(await r.deleteWorkoutType(e),u())})})}if(y==="stats"){const s=document.getElementById("stat-type-select");s==null||s.addEventListener("change",()=>{k=s.value,u()})}if(y==="profile-settings"){const s=document.getElementById("save-profile-btn");s==null||s.addEventListener("click",async()=>{const i=document.getElementById("profile-public-toggle"),n=document.getElementById("profile-history-toggle"),a=document.getElementById("profile-display-name");await r.updateProfileSettings({isPublic:(i==null?void 0:i.checked)??!1,showFullHistory:(n==null?void 0:n.checked)??!1,displayName:(a==null?void 0:a.value)||void 0}),u()});const t=document.getElementById("copy-profile-link");t==null||t.addEventListener("click",()=>{const n=`https://t.me/gymgym21bot/app?startapp=profile_${r.getProfileIdentifier()}`;navigator.clipboard.writeText(n).then(()=>{E("Ссылка скопирована")})});const e=document.getElementById("share-profile-link");e==null||e.addEventListener("click",()=>{const n=`https://t.me/gymgym21bot/app?startapp=profile_${r.getProfileIdentifier()}`;if(v!=null&&v.openTelegramLink){const a=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent("Мой профиль тренировок 💪")}`;v.openTelegramLink(a)}else navigator.clipboard.writeText(n).then(()=>{E("Ссылка скопирована")})})}}const $=document.createElement("div");$.className="sync-status";document.body.appendChild($);function Z(s){switch($.className="sync-status visible "+s,s){case"saving":$.textContent="Сохранение...";break;case"success":$.textContent="Сохранено";break;case"error":$.textContent="Ошибка сохранения";break;default:$.className="sync-status"}}r.onUpdate(()=>u());r.onSyncStatusChange(Z);async function B(){var e;const t=new URLSearchParams(window.location.search).get("startapp")||((e=v==null?void 0:v.initDataUnsafe)==null?void 0:e.start_param);if(t&&t.startsWith("profile_")){const i=t.replace("profile_","");N=i,y="public-profile",I=!1,u(),L=await r.getPublicProfile(i),L||(I=!0),u()}else u();await r.init()}B();
