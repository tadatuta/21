var P=Object.defineProperty;var R=(s,t,e)=>t in s?P(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var k=(s,t,e)=>R(s,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();const x="gym_twa_data",S="https://functions.yandexcloud.net/d4ehnqvq3a8fo55t7tj4";var U;const b=(U=window.Telegram)==null?void 0:U.WebApp,D={workoutTypes:[{id:"1",name:"Жим лежа"},{id:"2",name:"Приседания"},{id:"3",name:"Становая тяга"}],logs:[]};class q{constructor(){k(this,"data");k(this,"onUpdateCallback");k(this,"onSyncStatusChangeCallback");k(this,"status","idle");this.data=this.loadLocal()}getHeaders(){const t={"Content-Type":"application/json"};return b!=null&&b.initData&&(t["X-Telegram-Init-Data"]=b.initData),t}async init(){await this.syncFromServer()}onUpdate(t){this.onUpdateCallback=t}onSyncStatusChange(t){this.onSyncStatusChangeCallback=t}setStatus(t){var e;this.status=t,(e=this.onSyncStatusChangeCallback)==null||e.call(this,t),t==="success"&&setTimeout(()=>{this.status==="success"&&this.setStatus("idle")},2e3)}loadLocal(){const t=localStorage.getItem(x);if(!t)return D;try{return JSON.parse(t)}catch(e){return console.error("Failed to parse storage data",e),D}}saveLocal(){localStorage.setItem(x,JSON.stringify(this.data))}async syncFromServer(){var t;this.setStatus("saving");try{const e=await fetch(S,{headers:this.getHeaders()});if(e.ok){const a=await e.json();a&&(a.workoutTypes||a.logs)&&(this.data=a,this.saveLocal(),(t=this.onUpdateCallback)==null||t.call(this)),this.setStatus("success")}else this.setStatus("error")}catch(e){console.error("Failed to sync from server",e),this.setStatus("error")}}async saveToServer(){this.setStatus("saving");try{await fetch(S,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(this.data)}),this.setStatus("success")}catch(t){console.error("Failed to save to server",t),this.setStatus("error")}}async persist(){this.saveLocal(),await this.saveToServer()}getWorkoutTypes(){return this.data.workoutTypes}async addWorkoutType(t){const e={id:Date.now().toString(),name:t};return this.data.workoutTypes.push(e),await this.persist(),e}async deleteWorkoutType(t){this.data.workoutTypes=this.data.workoutTypes.filter(e=>e.id!==t),await this.persist()}getLogs(){return this.data.logs}async addLog(t){const e={...t,id:Date.now().toString(),date:new Date().toISOString()};return this.data.logs.push(e),await this.persist(),e}async deleteLog(t){this.data.logs=this.data.logs.filter(e=>e.id!==t),await this.persist()}async updateLog(t){const e=this.data.logs.findIndex(a=>a.id===t.id);e!==-1&&(this.data.logs[e]=t,await this.persist())}getProfile(){return this.data.profile}getProfileIdentifier(){var a,i;const t=this.data.profile;if(t!=null&&t.telegramUsername)return t.telegramUsername;if(t!=null&&t.telegramUserId)return`id_${t.telegramUserId}`;const e=(i=(a=b==null?void 0:b.initDataUnsafe)==null?void 0:a.user)==null?void 0:i.id;return e?`id_${e}`:""}async updateProfileSettings(t){var l,o;const e=(l=b==null?void 0:b.initDataUnsafe)==null?void 0:l.user,a=e==null?void 0:e.id,i=e==null?void 0:e.username,n=e==null?void 0:e.photo_url;this.data.profile?n&&(this.data.profile.photoUrl=n):this.data.profile={isPublic:!1,showFullHistory:!1,telegramUserId:a||0,telegramUsername:i,photoUrl:n,createdAt:new Date().toISOString()},this.data.profile={...this.data.profile,...t},await this.persist(),(o=this.onUpdateCallback)==null||o.call(this)}async getPublicProfile(t){try{const e=await fetch(`${S}?profile=${encodeURIComponent(t)}`);return e.ok?await e.json():null}catch(e){return console.error("Failed to fetch public profile",e),null}}}const d=new q;var C;const f=(C=window.Telegram)==null?void 0:C.WebApp;f&&(f.ready(),f.expand());let y="main",_="all",v=null,j=null,L=null,I=!1;function F(s){y=s,g()}let T=null;function E(s){let t=document.querySelector(".toast");t||(t=document.createElement("div"),t.className="toast",document.body.appendChild(t)),t.textContent=s,t.classList.add("visible"),T&&clearTimeout(T),T=setTimeout(()=>{t==null||t.classList.remove("visible")},2e3)}function g(){const s=document.getElementById("app");s&&(s.innerHTML=`
  ...
  `,s.querySelectorAll(".navigation__item").forEach(t=>{t.addEventListener("click",()=>{const e=t.getAttribute("data-page");F(e)})}),Y())}function M(){switch(y){case"main":return H();case"stats":return G();case"settings":return W();case"profile-settings":return V();case"public-profile":return z();default:return""}}let w=0;function O(s){const t=new Date;t.setHours(0,0,0,0);const e=new Date(t);e.setDate(t.getDate()-s*7),e.setHours(23,59,59,999);const a=new Date(e);return a.setDate(e.getDate()-6),a.setHours(0,0,0,0),{start:a,end:e,label:`${a.toLocaleDateString("ru-RU",{day:"numeric",month:"short"})} - ${e.toLocaleDateString("ru-RU",{day:"numeric",month:"short"})}`}}function H(){var l;const s=d.getWorkoutTypes(),t=d.getLogs(),e=t[t.length-1],a=e==null?void 0:e.workoutTypeId,i=v?t.find(o=>o.id===v):null,{label:n}=O(w);return`
    <div class="page-content" id="main-content">
      ...
      <div class="recent-logs">
        <div class="recent-logs__header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
           ...
           <h2 class="subtitle" style="margin: 0; cursor: pointer; display: flex; align-items: center; gap: 8px;" id="calendar-trigger">
             ${w===0?"Последние 7 дней":n}
             <span style="font-size: 1rem;">📅</span>
           </h2>
           <input type="date" id="week-date-picker" style="position: absolute; opacity: 0; width: 1px; height: 1px; bottom: 0; left: 0;" max="${new Date().toISOString().split("T")[0]}">
  ...
  `}function V(){var r,p;const s=d.getProfile(),t=(s==null?void 0:s.isPublic)??!1,e=(s==null?void 0:s.displayName)||((p=(r=f==null?void 0:f.initDataUnsafe)==null?void 0:r.user)==null?void 0:p.first_name)||"",a=d.getProfileIdentifier(),i=a?`https://t.me/gymgym21bot/app?startapp=profile_${a}`:"",n=d.getLogs(),l=n.reduce((c,u)=>c+u.weight*u.reps,0),o=new Set(n.map(c=>c.date.split("T")[0])).size;return`
  ...
  `}function G(){const s=d.getLogs(),t=d.getWorkoutTypes();if(s.length===0)return`
      <div class="page-content">
        <h1 class="title">Статистика</h1>
        <p class="hint">Недостаточно данных для статистики</p>
      </div>
    `;const e=_==="all"?s:s.filter(n=>n.workoutTypeId===_),a=e.reduce((n,l)=>n+l.weight*l.reps,0),i=e.reduce((n,l)=>n+l.reps,0);return`
    <div class="page-content">
      <h1 class="title">Статистика</h1>
      ...
      <div class="form-group">
        ...
        <select class="select" id="stat-type-select">
          ...
          ${t.map(n=>`<option value="${n.id}" ${_===n.id?"selected":""}>${n.name}</option>`).join("")}
        </select>
      </div>

      <div class="stats-grid">
        <div class="stat-card">
          <div class="stat-card__label">Объем (${_==="all"?"все":"тип"})</div>
  ...
  `}function J(s){if(s.length<2)return'<p class="hint" style="text-align: center">Мало данных для графика</p>';const e=[...s].sort((c,u)=>new Date(c.date).getTime()-new Date(u.date).getTime()).map(c=>c.weight),a=Math.min(...e),i=Math.max(...e),n=i-a||1,l=400,o=150,r=20,p=e.map((c,u)=>{const m=r+u/(e.length-1)*(l-2*r),h=o-r-(c-a)/n*(o-2*r);return`${m},${h}`}).join(" ");return`
    <svg viewBox="0 0 ${l} ${o}" class="chart">
      <polyline
        ...
        points="${p}"
      />
      ${e.map((c,u)=>{const m=r+u/(e.length-1)*(l-2*r),h=o-r-(c-a)/n*(o-2*r);return`<circle cx="${m}" cy="${h}" r="4" fill="var(--color-bg)" stroke="var(--color-link)" stroke-width="2" />`}).join("")}
    </svg>
    <div style="display: flex; justify-content: space-between; margin-top: 8px;">
      <span class="hint">${a}кг</span>
      <span class="hint">${i}кг</span>
    </div>
  `}function K(s){const t=d.getLogs(),e=d.getWorkoutTypes(),a=t.filter(p=>p.date.startsWith(s));if(a.length===0)return"";const n=new Date(a[0].date).toLocaleDateString("ru-RU",{day:"numeric",month:"long"}),l=new Map;a.forEach(p=>{l.has(p.workoutTypeId)||l.set(p.workoutTypeId,[]),l.get(p.workoutTypeId).push(p)});let o=`🏋️ Тренировка ${n}

`;l.forEach((p,c)=>{const u=e.find(m=>m.id===c);o+=`${(u==null?void 0:u.name)||"Упражнение"}:
`,p.forEach(m=>{o+=`  ${m.weight} кг × ${m.reps}
`}),o+=`
`});const r=a.reduce((p,c)=>p+c.weight*c.reps,0);return o+=`💪 Общий объём: ${Math.round(r)} кг`,o}function X(s){const t=K(s);if(t)if(f!=null&&f.openTelegramLink){const e=`https://t.me/share/url?url=${encodeURIComponent("https://t.me/gymgym21bot")}&text=${encodeURIComponent(t)}`;f.openTelegramLink(e)}else navigator.clipboard.writeText(t).then(()=>{alert("Текст скопирован в буфер обмена")})}function Y(){if(y==="main"){const s=document.getElementById("log-form");s==null||s.addEventListener("submit",async o=>{o.preventDefault();const r=new FormData(s),p={workoutTypeId:r.get("typeId"),weight:parseFloat(r.get("weight")),reps:parseInt(r.get("reps"),10)};if(v){const u=d.getLogs().find(m=>m.id===v);u&&(await d.updateLog({...u,...p}),v=null)}else await d.addLog(p);g()});const t=document.getElementById("duplicate-last-btn");t==null||t.addEventListener("click",async()=>{const o=d.getLogs(),r=o[o.length-1];r&&(await d.addLog({workoutTypeId:r.workoutTypeId,weight:r.weight,reps:r.reps}),g())});const e=document.getElementById("cancel-edit-btn");e==null||e.addEventListener("click",()=>{v=null,g()}),document.querySelectorAll(".log-set__delete").forEach(o=>{o.addEventListener("click",async()=>{const r=o.getAttribute("data-id");r&&(v===r&&(v=null),await d.deleteLog(r),g())})}),document.querySelectorAll(".log-set__edit").forEach(o=>{o.addEventListener("click",()=>{v=o.getAttribute("data-id"),g(),window.scrollTo({top:0,behavior:"smooth"})})}),document.querySelectorAll(".share-btn").forEach(o=>{o.addEventListener("click",()=>{const r=o.getAttribute("data-date");r&&X(r)})});const a=document.getElementById("prev-week-btn");a==null||a.addEventListener("click",()=>{w++,g()});const i=document.getElementById("next-week-btn");i==null||i.addEventListener("click",()=>{w>0&&(w--,g())});const n=document.getElementById("calendar-trigger"),l=document.getElementById("week-date-picker");n==null||n.addEventListener("click",()=>{if("showPicker"in l)try{l.showPicker()}catch{l.click()}else l.click()}),l==null||l.addEventListener("change",()=>{if(l.value){const o=new Date(l.value),r=new Date;r.setHours(0,0,0,0),o.setHours(0,0,0,0);const p=r.getTime()-o.getTime(),c=Math.floor(p/(1e3*60*60*24));c<0?w=0:w=Math.floor(c/7),g()}})}if(y==="settings"){const s=document.getElementById("add-type-form");s==null||s.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("new-type-name");e.value&&(await d.addWorkoutType(e.value),g())}),document.querySelectorAll(".type-item__delete").forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");e&&confirm("Удалить этот тип тренировки?")&&(await d.deleteWorkoutType(e),g())})})}if(y==="stats"){const s=document.getElementById("stat-type-select");s==null||s.addEventListener("change",()=>{_=s.value,g()})}if(y==="profile-settings"){const s=document.getElementById("save-profile-btn");s==null||s.addEventListener("click",async()=>{const a=document.getElementById("profile-public-toggle"),i=document.getElementById("profile-history-toggle"),n=document.getElementById("profile-display-name");await d.updateProfileSettings({isPublic:(a==null?void 0:a.checked)??!1,showFullHistory:(i==null?void 0:i.checked)??!1,displayName:(n==null?void 0:n.value)||void 0}),g()});const t=document.getElementById("copy-profile-link");t==null||t.addEventListener("click",()=>{const i=`https://t.me/gymgym21bot/app?startapp=profile_${d.getProfileIdentifier()}`;navigator.clipboard.writeText(i).then(()=>{E("Ссылка скопирована")})});const e=document.getElementById("share-profile-link");e==null||e.addEventListener("click",()=>{const i=`https://t.me/gymgym21bot/app?startapp=profile_${d.getProfileIdentifier()}`;if(f!=null&&f.openTelegramLink){const n=`https://t.me/share/url?url=${encodeURIComponent(i)}&text=${encodeURIComponent("Мой профиль тренировок 💪")}`;f.openTelegramLink(n)}else navigator.clipboard.writeText(i).then(()=>{E("Ссылка скопирована")})})}}const $=document.createElement("div");$.className="sync-status";document.body.appendChild($);function B(s){switch($.className="sync-status visible "+s,s){case"saving":$.textContent="Сохранение...";break;case"success":$.textContent="Сохранено";break;case"error":$.textContent="Ошибка сохранения";break;default:$.className="sync-status"}}d.onUpdate(()=>g());d.onSyncStatusChange(B);async function Q(){var e;const t=new URLSearchParams(window.location.search).get("startapp")||((e=f==null?void 0:f.initDataUnsafe)==null?void 0:e.start_param);if(t&&t.startsWith("profile_")){const a=t.replace("profile_","");j=a,y="public-profile",I=!1,g(),L=await d.getPublicProfile(a),L||(I=!0),g()}else g();await d.init()}Q();
