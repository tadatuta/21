var O=Object.defineProperty;var q=(s,t,e)=>t in s?O(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var $=(s,t,e)=>q(s,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=e(a);fetch(a.href,n)}})();const D="gym_twa_data",T="https://functions.yandexcloud.net/d4ehnqvq3a8fo55t7tj4";var C;const h=(C=window.Telegram)==null?void 0:C.WebApp,E={workoutTypes:[{id:"1",name:"Жим лежа"},{id:"2",name:"Приседания"},{id:"3",name:"Становая тяга"}],logs:[]};class M{constructor(){$(this,"data");$(this,"onUpdateCallback");$(this,"onSyncStatusChangeCallback");$(this,"status","idle");this.data=this.loadLocal()}getHeaders(){const t={"Content-Type":"application/json"};return h!=null&&h.initData&&(t["X-Telegram-Init-Data"]=h.initData),t}async init(){await this.syncFromServer()}onUpdate(t){this.onUpdateCallback=t}onSyncStatusChange(t){this.onSyncStatusChangeCallback=t}setStatus(t){var e;this.status=t,(e=this.onSyncStatusChangeCallback)==null||e.call(this,t),t==="success"&&setTimeout(()=>{this.status==="success"&&this.setStatus("idle")},2e3)}loadLocal(){const t=localStorage.getItem(D);if(!t)return E;try{return JSON.parse(t)}catch(e){return console.error("Failed to parse storage data",e),E}}saveLocal(){localStorage.setItem(D,JSON.stringify(this.data))}async syncFromServer(){var t;this.setStatus("saving");try{const e=await fetch(T,{headers:this.getHeaders()});if(e.ok){const i=await e.json();i&&(i.workoutTypes||i.logs)&&(this.data=i,this.saveLocal(),(t=this.onUpdateCallback)==null||t.call(this)),this.setStatus("success")}else this.setStatus("error")}catch(e){console.error("Failed to sync from server",e),this.setStatus("error")}}async saveToServer(){this.setStatus("saving");try{await fetch(T,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(this.data)}),this.setStatus("success")}catch(t){console.error("Failed to save to server",t),this.setStatus("error")}}async persist(){this.saveLocal(),await this.saveToServer()}getWorkoutTypes(){return this.data.workoutTypes}async addWorkoutType(t){const e={id:Date.now().toString(),name:t};return this.data.workoutTypes.push(e),await this.persist(),e}async deleteWorkoutType(t){this.data.workoutTypes=this.data.workoutTypes.filter(e=>e.id!==t),await this.persist()}getLogs(){return this.data.logs}async addLog(t){const e={...t,id:Date.now().toString(),date:new Date().toISOString()};return this.data.logs.push(e),await this.persist(),e}async deleteLog(t){this.data.logs=this.data.logs.filter(e=>e.id!==t),await this.persist()}async updateLog(t){const e=this.data.logs.findIndex(i=>i.id===t.id);e!==-1&&(this.data.logs[e]=t,await this.persist())}getProfile(){return this.data.profile}getProfileIdentifier(){var i,a;const t=this.data.profile;if(t!=null&&t.telegramUsername)return t.telegramUsername;if(t!=null&&t.telegramUserId)return`id_${t.telegramUserId}`;const e=(a=(i=h==null?void 0:h.initDataUnsafe)==null?void 0:i.user)==null?void 0:a.id;return e?`id_${e}`:""}async updateProfileSettings(t){var a,n,o,l,c;const e=(n=(a=h==null?void 0:h.initDataUnsafe)==null?void 0:a.user)==null?void 0:n.id,i=(l=(o=h==null?void 0:h.initDataUnsafe)==null?void 0:o.user)==null?void 0:l.username;this.data.profile||(this.data.profile={isPublic:!1,telegramUserId:e||0,telegramUsername:i,createdAt:new Date().toISOString()}),this.data.profile={...this.data.profile,...t},await this.persist(),(c=this.onUpdateCallback)==null||c.call(this)}async getPublicProfile(t){try{const e=await fetch(`${T}?profile=${encodeURIComponent(t)}`);return e.ok?await e.json():null}catch(e){return console.error("Failed to fetch public profile",e),null}}}const r=new M;var j;const g=(j=window.Telegram)==null?void 0:j.WebApp;g&&(g.ready(),g.expand());let y="main",k="all",u=null,N=null,S=null,x=!1;function R(s){y=s,m()}let I=null;function U(s){let t=document.querySelector(".toast");t||(t=document.createElement("div"),t.className="toast",document.body.appendChild(t)),t.textContent=s,t.classList.add("visible"),I&&clearTimeout(I),I=setTimeout(()=>{t==null||t.classList.remove("visible")},2e3)}function m(){const s=document.getElementById("app");s&&(s.innerHTML=`
  ...
  `,s.querySelectorAll(".navigation__item").forEach(t=>{t.addEventListener("click",()=>{const e=t.getAttribute("data-page");R(e)})}),X())}function F(){switch(y){case"main":return P();case"stats":return z();case"settings":return H();case"profile-settings":return V();case"public-profile":return W();default:return""}}function P(){var n;const s=r.getWorkoutTypes(),t=r.getLogs(),e=t[t.length-1],i=e==null?void 0:e.workoutTypeId,a=u?t.find(o=>o.id===u):null;return`
  ...
  `}function A(){const s=r.getLogs(),t=r.getWorkoutTypes();if(s.length===0)return'<p class="hint">Пока нет записей</p>';const e=new Date,i=new Date(e.getTime()-7*24*60*60*1e3);i.setHours(0,0,0,0);const a=s.filter(l=>new Date(l.date)>=i);if(a.length===0)return'<p class="hint">За последнюю неделю записей нет</p>';const n=new Map;[...a].sort((l,c)=>new Date(c.date).getTime()-new Date(l.date).getTime()).forEach(l=>{const d=new Date(l.date).toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"long"});n.has(d)||n.set(d,[]),n.get(d).push(l)});let o="";return n.forEach((l,c)=>{var v;const d=((v=l[0])==null?void 0:v.date.split("T")[0])||"";o+='<div class="log-day">',o+=`<div class="log-day__header">
    ...
    </div>`;const p=new Map;l.forEach(f=>{p.has(f.workoutTypeId)||p.set(f.workoutTypeId,[]),p.get(f.workoutTypeId).push(f)}),p.forEach((f,_)=>{const L=t.find(b=>b.id===_);o+=`
  ...
  `}function G(s){if(s.length<2)return'<p class="hint" style="text-align: center">Мало данных для графика</p>';const e=[...s].sort((p,v)=>new Date(p.date).getTime()-new Date(v.date).getTime()).map(p=>p.weight),i=Math.min(...e),a=Math.max(...e),n=a-i||1,o=400,l=150,c=20,d=e.map((p,v)=>{const f=c+v/(e.length-1)*(o-2*c),_=l-c-(p-i)/n*(l-2*c);return`${f},${_}`}).join(" ");return`
  ...
  `}function J(s){const t=r.getLogs(),e=r.getWorkoutTypes(),i=t.filter(d=>d.date.startsWith(s));if(i.length===0)return"";const n=new Date(i[0].date).toLocaleDateString("ru-RU",{day:"numeric",month:"long"}),o=new Map;i.forEach(d=>{o.has(d.workoutTypeId)||o.set(d.workoutTypeId,[]),o.get(d.workoutTypeId).push(d)});let l=`🏋️ Тренировка ${n}

`;o.forEach((d,p)=>{const v=e.find(f=>f.id===p);l+=`${(v==null?void 0:v.name)||"Упражнение"}:
`,d.forEach(f=>{l+=`  ${f.weight} кг × ${f.reps}
`}),l+=`
`});const c=i.reduce((d,p)=>d+p.weight*p.reps,0);return l+=`💪 Общий объём: ${Math.round(c)} кг`,l}function K(s){const t=J(s);if(t)if(g!=null&&g.openTelegramLink){const e=`https://t.me/share/url?url=${encodeURIComponent("https://t.me/gymgym21bot")}&text=${encodeURIComponent(t)}`;g.openTelegramLink(e)}else navigator.clipboard.writeText(t).then(()=>{alert("Текст скопирован в буфер обмена")})}function X(){if(y==="main"){const s=document.getElementById("log-form");s==null||s.addEventListener("submit",async i=>{i.preventDefault();const a=new FormData(s),n={workoutTypeId:a.get("typeId"),weight:parseFloat(a.get("weight")),reps:parseInt(a.get("reps"),10)};if(u){const l=r.getLogs().find(c=>c.id===u);l&&(await r.updateLog({...l,...n}),u=null)}else await r.addLog(n);m()});const t=document.getElementById("duplicate-last-btn");t==null||t.addEventListener("click",async()=>{const i=r.getLogs(),a=i[i.length-1];a&&(await r.addLog({workoutTypeId:a.workoutTypeId,weight:a.weight,reps:a.reps}),m())});const e=document.getElementById("cancel-edit-btn");e==null||e.addEventListener("click",()=>{u=null,m()}),document.querySelectorAll(".log-set__delete").forEach(i=>{i.addEventListener("click",async()=>{const a=i.getAttribute("data-id");a&&(u===a&&(u=null),await r.deleteLog(a),m())})}),document.querySelectorAll(".log-set__edit").forEach(i=>{i.addEventListener("click",()=>{u=i.getAttribute("data-id"),m(),window.scrollTo({top:0,behavior:"smooth"})})}),document.querySelectorAll(".share-btn").forEach(i=>{i.addEventListener("click",()=>{const a=i.getAttribute("data-date");a&&K(a)})})}if(y==="settings"){const s=document.getElementById("add-type-form");s==null||s.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("new-type-name");e.value&&(await r.addWorkoutType(e.value),m())}),document.querySelectorAll(".type-item__delete").forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");e&&confirm("Удалить этот тип тренировки?")&&(await r.deleteWorkoutType(e),m())})})}if(y==="stats"){const s=document.getElementById("stat-type-select");s==null||s.addEventListener("change",()=>{k=s.value,m()})}if(y==="profile-settings"){const s=document.getElementById("save-profile-btn");s==null||s.addEventListener("click",async()=>{const i=document.getElementById("profile-public-toggle"),a=document.getElementById("profile-display-name");await r.updateProfileSettings({isPublic:(i==null?void 0:i.checked)??!1,displayName:(a==null?void 0:a.value)||void 0}),m()});const t=document.getElementById("copy-profile-link");t==null||t.addEventListener("click",()=>{const a=`https://t.me/gymgym21bot/app?startapp=profile_${r.getProfileIdentifier()}`;navigator.clipboard.writeText(a).then(()=>{U("Ссылка скопирована")})});const e=document.getElementById("share-profile-link");e==null||e.addEventListener("click",()=>{const a=`https://t.me/gymgym21bot/app?startapp=profile_${r.getProfileIdentifier()}`;if(g!=null&&g.openTelegramLink){const n=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent("Мой профиль тренировок 💪")}`;g.openTelegramLink(n)}else navigator.clipboard.writeText(a).then(()=>{U("Ссылка скопирована")})})}}const w=document.createElement("div");w.className="sync-status";document.body.appendChild(w);function Y(s){switch(w.className="sync-status visible "+s,s){case"saving":w.textContent="Сохранение...";break;case"success":w.textContent="Сохранено";break;case"error":w.textContent="Ошибка сохранения";break;default:w.className="sync-status"}}r.onUpdate(()=>m());r.onSyncStatusChange(Y);async function Q(){var e;const t=new URLSearchParams(window.location.search).get("startapp")||((e=g==null?void 0:g.initDataUnsafe)==null?void 0:e.start_param);if(t&&t.startsWith("profile_")){const i=t.replace("profile_","");N=i,y="public-profile",x=!1,m(),S=await r.getPublicProfile(i),S||(x=!0),m()}else m();await r.init()}Q();
